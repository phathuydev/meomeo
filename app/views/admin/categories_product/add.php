      ...
      <div class="bg-secondary rounded h-100 p-4">
        ...
        <form action="" method="post">
          <div class=" mb-3">
            ...
            <input type="text" class="form-control" name="nameCategoriesProduct" id="floatingInput" placeholder="VD: Mèo Ai Cập">
          </div>
          <div class="float-end mb-3">
            <a href="<?= _WEB_ROOT ?>/danh-sach-danh-muc-san-pham/trang-1" class="btn btn-outline-info me-1">Trở lại</a>
            <button type="submit" name="addCategoriesProduct" class="btn btn-outline-danger">Thêm</button>
          </div>
        </form>
      </div>
    </div>
