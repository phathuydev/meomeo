      ...
      <div class="bg-secondary rounded h-100 p-4">
        ...
        <form action="" method="post">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="floatingInput" placeholder="VD: Bài viết số 1">
          </div>
          <div class="mb-3">
          ...
          <div class="float-end mb-3">
            <a href="<?= _WEB_ROOT ?>/danh-sach-baiviet" class="btn btn-outline-info me-1">Trở lại</a>
