    ...
    <div class="col-sm-12 col-xl-12">
      <div class="bg-secondary rounded h-100 p-4">
        ...
        <form action="" method="post">
          ...
          <div class="mb-3">
            <label for="floatingInput" class="form-label">Ảnh sản phẩm <span class="text-danger">*</span></label>
            <input class="form-control bg-dark" type="file" id="floatingInput">
          </div>
          <div class="mb-3">
            <label for="floatingInput" class="form-label">Băng rôn sản phẩm <span class="text-danger">*</span></label>
