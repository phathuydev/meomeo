            ...
            <form action="" method="post">
              ...
              <tbody>
                <tr class="">
                  ...
                  <td><p class="text-danger">Bị Hủy</p></td>
                  <td>
                ...
                <tr class="">
                  <td>#AEC766</td>
                  <td>Lữ Phát Huy</td>
                  <td>Chờ xác nhận <a href="<?= _WEB_ROOT ?>/cap-nhat-trang-thai-don-hang"><i class="fa fa-edit"></i></a></td>
                  <td><p class="text-white">Bình thường</p></td>
                  <td>
                    <a href="<?= _WEB_ROOT ?>/xem-them-don-hang" class="btn btn-outline-warning">Xem thêm</a>
                    <a href="<?= _WEB_ROOT ?>/chi-tiet-don-hang" class="btn btn-outline-info">Chi tiết</a>
                  </td>
                </tr>
              </tbody>
            </form>
